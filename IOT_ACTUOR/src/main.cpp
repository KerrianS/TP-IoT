...
void setup()
{
	...
	// Test LED - Faire clignoter la LED 5 fois avec digitalWrite direct
	for(int i = 0; i < 5; i++) {
		digitalWrite(LIGHT_PIN, HIGH);  // Allumer directement
		delay(500);
		digitalWrite(LIGHT_PIN, LOW);   // Éteindre directement
		delay(500);
	}
